<button wire:click="toggle" type="button" class="flex items-center appearance-none focus:outline-none">
    @if ($this->qty)
        <span class="inline-block mr-2 text-sm text-white">{{ $this->qty }}</span>
    @endif
